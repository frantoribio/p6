        ...
        if (args.length != 6) {
            ...
            try {
                ...
                if (checkParameters(dimension, droides, tiempo)) {
                    // Creo Cuadricula
                    SistemaApuntado sistemaApuntado = SistemaApuntado.getInstance(dimension, droides, tiempo);
                    sistemaApuntado.init();
                    sistemaApuntado.run();
                    sistemaApuntado.report();
